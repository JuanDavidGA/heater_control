...
time_1 = time_sample.time_sec(1:3060,:);
% Data from Temp 2 
temp_sensor_2 = temp_data_2.Temperature(:);
time_2 = time_sample.time_sec(1:3060,:);
% Data from Temp 3 
temp_sensor_3 = temp_data_3.Temperature(17772:20791,:);
time_3 = time_sample.time_sec(1:3020,:);
